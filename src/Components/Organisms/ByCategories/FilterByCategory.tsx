...
export const FilterByCategory=(props:Props) =>{
    ...
    const [books, setBooks] = useState<BookInfo[]>([
     ...
     useEffect(()=>{
         if((props.booksStatus) ==="TrendingBlinks"){
             booksCategory("TrendingBlinks");
         }else if((props.booksStatus) ==="JustAdded"){
             booksCategory("JustAdded");
         }else if((props.booksStatus) ==="FeaturedBlinks"){
             booksCategory("FeaturedBlinks");
         }
     })
     return(
         <>
